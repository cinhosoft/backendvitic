...
import  co.com.vitic.apivitic.config.JWTAuthorizationFilter;
@SpringBootApplication
public class ApiviticApplication {

	public static void main(String[] args) {
		SpringApplication.run(ApiviticApplication.class, args);
	}
